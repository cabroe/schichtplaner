...
interface EmployeeDialogProps {
  ...
  onDelete?: (employee: Employee) => void  // Changed from EmployeeFormData to Employee
  initialData?: EmployeeFormData
  departments: Department[]
}


export function EmployeeDialog({ isOpen, onClose, onSubmit, onDelete, initialData, departments }: EmployeeDialogProps) {
  ...
  const handleDelete = () => {
    if (initialData && onDelete) {
      onDelete(initialData as Employee)
